...
SLOT="0"
KEYWORDS="~amd64"
IUSE="blas cuda ffmpeg hip opencl vulkan" # sdl2
...
# SDL support is broken due to llama-cpp dependency
#	sdl2? ( media-libs/libsdl2:= sci-misc/llama-cpp:= )"
DEPEND="${CDEPEND}
...
src_configure() {
	...
	local mycmakeargs=(
		...
		-Dllama_DIR=/usr/$(get_libdir)/llama.cpp/cmake/llama/
