...
src_compile() {
	epatch "${FILESDIR}"/grub-1.96-915resolution-0.5.2-3.patch || die "915resolutin patch failed"
	#http://m0squito.blogspot.com/2008/11/1024x600-msi-wind-asus-eeepc.html
