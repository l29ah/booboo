...
inherit cmake-utils python-any-r1 games git-r3

DESCRIPTION="A free turn-based space empire and galactic conquest game"
HOMEPAGE="http://www.freeorion.org"
EGIT_REPO_URI="https://github.com/freeorion/freeorion"
...
src_prepare() {
	...
	# remove cheats
	use debug || {
		rm default/scripting/species/SP_SUPERTEST.focs.txt default/scripting/buildings/SUPER_TEST.focs.txt default/scripting/buildings/colonies/SP_SUPER_TEST.focs.txt
	}
}
...
src_install() {
	# data files
	rm "${CMAKE_USE_DIR}"/default/COPYING
