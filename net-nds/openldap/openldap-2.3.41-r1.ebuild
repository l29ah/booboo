...
# $Header: /var/cvsroot/gentoo-x86/net-nds/openldap/openldap-2.3.41-r1.ebuild,v 1.1 2008/05/21 18:23:20 caleb Exp $
...
src_unpack() {
	...
	# bug #225369
	epatch "${FILESDIR}"/${PN}-2.3.41-r1-fixed-peercred-error.patch
}
