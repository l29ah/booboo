...
GIT_UPDATE_7_SRC="patch-2.6.29-git7.bz2"
GIT_UPDATE_7_URI="mirror://kernel/linux/kernel/v2.6/snapshots/patch-2.6.29-git7.bz2"
...
UNIPATCH_LIST="${DISTDIR}/patch-2.6.29-git7.bz2
${UNIPATCH_LIST}"
