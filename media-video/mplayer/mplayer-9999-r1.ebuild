...
+schroedinger sdl +speex sse sse2 ssse3 +static-lavc svga teletext tga +theora +tremor
...
RDEPEND="sys-libs/ncurses
	...
	!static-lavc? ( media-video/ffmpeg )"
...
src_compile() {
	...
	use static-lavc || myconf="$myconf --disable-libavutil_a --disable-libavcodec_a --disable-libavformat_a --disable-libpostproc_a	--disable-libswscale_a"
	if use custom-cflags; then
